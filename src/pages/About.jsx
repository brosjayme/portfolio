        ...
        <div className="flex flex-col justify-center items-center w-full h-full">
          <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8">
            <div className="sm:text-right pb-8 pl-4">
              <p className="text-4xl font-bold inline border-b-4 border-pink-600 text-gray-600">
                About
              </p>
            </div>
            <div></div>
          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-4">
            <div className="sm:text-right text-4xl font-bold pl-2 text-gray-300">
              <p>
                Hi. I'm Okoro John, nice to meet you. Please take a look around.
              </p>
            </div>
            <div className="text-white">
              <p className="pl-4">
                Welcome to my Front End Development portfolio! I am a passionate
                and experienced frontend developer with a focus on building
                visually stunning, user-friendly, and responsive websites. I
                specialize in crafting unique and memorable user experiences
                through creative design and intuitive functionality. I have
                worked with a wide range of clients, from small startups to
                large corporations, and have gained expertise in frontend
                development technologies such as HTML, CSS, JavaScript, jQuery,
                and React.
              </p>
