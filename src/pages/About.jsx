...
const About = () => {
  return (
     ...
     <NavBar/>
     {/* <SocialLinks/> */}
    <div name='about' className='w-full h-screen bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-4'>
            ...
            <div className='text-white'>
              <p className='pl-4'>Welcome to my Front End Development portfolio! I am a passionate and experienced front end developer with a focus on building visually stunning, user-friendly, and responsive websites. I specialize in crafting unique and memorable user experiences through creative design and intuitive functionality.
